 ...
 * 
 */
@WebServiceClient(name = "CategoriaService", targetNamespace = "http://Servicios/", wsdlLocation = "http://localhost:8080/MisOfertasWebService/CategoriaService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/MisOfertasWebService/CategoriaService?WSDL");
